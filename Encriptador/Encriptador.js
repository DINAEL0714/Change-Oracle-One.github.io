function encriptar(traduccion){
    var textarea = document.querySelector(".textoin");
    const texto = textarea.value;
    var area_default = document.querySelector(".banner");
...
boton1.addEventListener( 'click', function() {encriptar(traduccion);} );
boton2.addEventListener( 'click', function() {desencriptar(traduccion);} );
